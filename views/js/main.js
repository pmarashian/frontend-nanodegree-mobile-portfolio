 ...
 *
 * @method resizePizzas
 * @param {Integer} size New size of pizzas.
 */
var resizePizzas = function(size) {
    ...
    // moved functions outside of resizePizzas.
...
function changeSliderLabel(size) {
    ...
    document.getElementById("pizzaSize").innerHTML = label;
 ...
 *
 * @method determineDx
 * @param {element} elem The pizza element.
 * @param {Integer} size The new pizza size.
 * @param {Integer} windowwidth The width of the #randompizzas element.
 */
function determineDx (elem, size, windowwidth) {
     ...
     *
     * @method sizeSwitcher
     * @param {string} size The new pizza size.
     */
...
function changePizzaSizes(size) {
    ...
    var windowwidth = document.getElementById("randomPizzas").offsetWidth,
        dx = determineDx( randomPizzaContainers[0], size, windowwidth ),
        newwidth = (randomPizzaContainers[0].offsetWidth + dx) + 'px';
...
// variable to store reference to all random pizzas.
